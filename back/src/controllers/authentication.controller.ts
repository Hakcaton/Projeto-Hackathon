import { Controller, Request, HttpException, HttpStatus, Post, Res } from '@nestjs/common';
...
export class AuthenticationController {
    ...
    async Login(@Request() req, @Res() res: Response) {
        ...
        res.status(HttpStatus.ACCEPTED).send({ authToken: await this.authService.generateToken(userId) })
    }
}
